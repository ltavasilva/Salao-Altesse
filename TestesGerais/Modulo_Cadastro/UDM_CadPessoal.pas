...
uses
  System.SysUtils, System.Classes, DbxDevartMySql, Data.FMTBcd,
  Datasnap.Provider, Data.SqlExpr, Data.DB, Datasnap.DBClient, Data.DBXOdbc,
...
type
  TDM_CadPessoal = class(TDataModule)
    ...
    Qry_Exec: TADOQuery;
    CDS_Pessoal: TClientDataSet;
    CDS_Pessoalid_pessoal: TAutoIncField;
    CDS_Pessoalnome: TStringField;
    CDS_Pessoaldata_nasci: TDateField;
    CDS_Pessoalrg: TStringField;
    CDS_Pessoalcpf: TStringField;
    CDS_Pessoaldata_incl: TDateTimeField;
    CDS_Pessoalresp_incl: TIntegerField;
    CDS_Pessoaldata_modif: TDateTimeField;
    CDS_Pessoalresp_modif: TIntegerField;
    CDS_Pessoalativo: TSmallintField;
    Tp_Endereconum: TIntegerField;
    CDS_Endereco: TClientDataSet;
    CDS_Tel: TClientDataSet;
    CDS_Enderecocep: TStringField;
    CDS_Enderecologradouro: TStringField;
    CDS_Enderecobairro: TStringField;
    CDS_Enderecocidade: TStringField;
    CDS_Enderecouf: TStringField;
    CDS_Endereconum: TIntegerField;
    CDS_Enderecoid_tipo: TIntegerField;
    CDS_Enderecoid_pessoal: TIntegerField;
    CDS_Teltelefone: TStringField;
    CDS_Telid_pessoal: TIntegerField;
    CDS_Telid_tipo: TIntegerField;
    CDS_EnderecoTipo: TStringField;
    CDS_TelTipo: TStringField;
    CDS_Email: TClientDataSet;
    CDS_EmailTipo: TStringField;
    CDS_Emailemail: TStringField;
    CDS_Emailid_pessoal: TIntegerField;
    CDS_Emailid_tipo: TIntegerField;
